...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. controlMask, xK_q), sendMessage $ DecGap 5 R)  -- decrement the right-hand gap<Paste>
...
--
-- myLayout = avoidStruts (spacingRaw False (Border 5 0 5 0) True (Border 0 5 0 5) True $ tiled ||| Mirror tiled ||| Full)
...
--
main = do
	xmproc <- spawnPipe "xmobar -x 0 /home/yashdev/.config/xmobar/xmobar.config"
	xmonad $ docks def {
      -- simple stuff
        terminal           = myTerminal,
